...
// 猜测可能的数据的纬度
static const int DIMEN_DATA = 2000;
...
// 猜测可能的数据的纬度
static const int DIMEN_DATA = 2000;     // 猜测特征不会超过 5000 维度
static const int MAXS = 1024*1024*1024;  // 最大可以存储 1024M 的数据
static const int MAXL = 10000;     // 猜测文件可能的最大行数  这里猜测 2万 行
...
features_labels TrainData_Set[MAXL];    // 数据存储区域
features_labels TestData_Set[MAXL];

double weight_param[MAXL];      // 权重系数
